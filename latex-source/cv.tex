...
%  \entry
%    {2009-11}
%    {Bridging the Gap, Kent}
%    {Volunteering}
%    {Helped out with a semi-annual program run by the Kent School District. Distributed computers to families in need, and provided them with free basic training on computer usage.}
%  \entry
%    {2009-12}
%    {Website Manager, ECCSKC}
%    {Volunteering}
%    {Maintained a WordPress blog, MediaWiki .}
\end{entrylist}
